    ...
    public partial class Form_UserManagment : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                p.AddUserOrder(txt_User.Text, 1, 1, 1, 1, 1, 1,1);
                p.AddUserPurshise(txt_User.Text, 1, 1, 1, 1,1);
                p.AddUserStock(txt_User.Text, 1, 1, 1, 1, 1, 1, 1, 1);
                p.AddUserFile(txt_User.Text, 1, 1, 1, 1, 1,1,1,1);

                l.addMoveUser(Program.salesman, this.Text, $" تسجيل مستخدم جديد {txt_User.Text}");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (MessageBox.Show("هل تريد تعديل بيانات المستخدم", "تعديل بيانات المستخدم", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    l.SelectUsers();
                    l.addMoveUser(Program.salesman, this.Text, $"تعديل علي بيانات مستخدم");
