                ...
                if (dataGridView1.Rows.Count >= 1)
                {
                    ...
                    if (RdbAllPay.Checked == true)
                    {
                        ...
                        {                           
                            ...
                            s.addSanad("سند قبض", Txt_SalesMan.Text, comboBox1.Text, Convert.ToDecimal(dataGridView1.CurrentRow.Cells[1].Value), 
                                dateTimePicker1.Value, $"سند قبض مبلغ {dataGridView1.CurrentRow.Cells[1].Value} من عميل {comboBox1.Text}");
                    ...
                    else if (rdbPartPay.Checked == true)
                    {
...

                        {
                            if (Convert.ToDecimal(txt_prise.Text) > 0)
                            {
                                ...
                                s.addSanad("سند قبض", Txt_SalesMan.Text, comboBox1.Text, Convert.ToDecimal(txt_prise.Text),
                        dateTimePicker1.Value, $"سند قبض مبلغ {txt_prise.Text} من عميل {comboBox1.Text}");
                                txt_prise.Text = "0";
