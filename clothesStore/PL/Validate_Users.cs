        ...
        private void simpleButton4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (check_RetrunPurshasesAllProduct.Checked == true) { ReportReturnSuppliersAllproduct = 1; }

                    else if (check_RetrunPurshasesAllProduct.Checked == false) { ReportReturnSuppliersAllproduct = 0; }
                    ///////
