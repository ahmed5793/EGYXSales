...
namespace clothesStore.PL
{
    ...
    private void Btn_search_Click(object sender, EventArgs e)
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            Login l = new Login();
            l.addMoveUser(Program.salesman, this.Text, $"بحث في تقرير الارصدة المضافة الي خزينة({cmb_Stock.Text}),في الفترة مابين {DateFrom.Text} الي فترة {DateTo.Text}");
            // calc();
        }
        ...
        private void Btn_Print_Click(object sender, EventArgs e)
        {
            ...
            Login l = new Login();
            l.addMoveUser(Program.salesman, this.Text, $"طباعه تقرير شامل الارصدة المضافة الي خزينة({cmb_Stock.Text}),في الفترة مابين {DateFrom.Text} الي فترة {DateTo.Text}");
