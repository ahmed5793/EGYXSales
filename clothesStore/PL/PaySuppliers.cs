                    ...
                    if (RdbAllPay.Checked == true)
                    {
                        ...
                        {                           
                            ...
                            if (Convert.ToDecimal(dataGridView1.CurrentRow.Cells[1].Value) >0 && comboBox1.Text!="")
                            {
                                ...
                                st.InsertStockMove(Convert.ToDecimal(dataGridView1.CurrentRow.Cells[1].Value), dateTimePicker1.Value, "حساب مورد", $"مدفوعات للمورد  {comboBox1.Text}", Convert.ToInt32(cmb_Stock.SelectedValue), Txt_SalesMan.Text, "خروج من الخزينة");
                                ...
                                st.addSanad("سند دفع", Txt_SalesMan.Text, comboBox1.Text, Convert.ToDecimal(dataGridView1.CurrentRow.Cells[1].Value),
                                            dateTimePicker1.Value, $"سند دفع مبلغ {dataGridView1.CurrentRow.Cells[1].Value} من مورد {comboBox1.Text}");
                    ...
                    else if (rdbPartPay.Checked == true )
                    {
...

                        {
                           ...
                           s.AddPaySuppliers(Convert.ToInt32(comboBox1.SelectedValue), Convert.ToDecimal(txt_prise.Text)
                            ...
                            st.InsertStockMove(Convert.ToDecimal(txt_prise.Text) * -1, dateTimePicker1.Value, "حساب مورد", $"مدفوعات للمورد  {comboBox1.Text}", Convert.ToInt32(cmb_Stock.SelectedValue), Txt_SalesMan.Text, "خروج من الخزينة");
                            ...
                            st.addSanad("سند دفع", Txt_SalesMan.Text, comboBox1.Text, Convert.ToDecimal(txt_prise.Text),
                                        dateTimePicker1.Value, $"سند دفع مبلغ {txt_prise.Text} من مورد {comboBox1.Text}");
