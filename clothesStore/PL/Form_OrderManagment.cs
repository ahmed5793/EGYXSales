...
namespace clothesStore.PL
{
    public partial class Form_OrderManagment : Form
    {
        ...
        private static Form_OrderManagment farm;

        static void STATUESCllosed(object sender, FormClosedEventArgs e)
        {
            farm = null;
        }
        public static Form_OrderManagment getmain
        {
            get
            {
                if (farm == null)
                {
                    farm = new Form_OrderManagment();
        ...
        private void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            if (e.Column.Name== "Btn_Update")
            {
                try
                {
                    ...
                    Frm_UpdateOrderSales frm_UpdateSales = new Frm_UpdateOrderSales();
