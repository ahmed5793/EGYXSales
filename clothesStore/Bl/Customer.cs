...
namespace clothesStore.Bl
{
    class Customer
    {
        ...
        internal DataTable VildateCustomerName(string name)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("VildateCustomerName", param);
            da.close();
            return dt;
        }
        ...
        internal void AddOpeningBalance( DateTime Date, decimal Moneydiscount, decimal Moneyadd, string Elbyan,
            string Type, int? id_Supp=null, int? id_cust = null)
        {
            ...
            param[3].Value = Elbyan;
            param[4] = new SqlParameter("@Type", SqlDbType.NVarChar,100);
            param[4].Value = Type;
            param[5] = new SqlParameter("@id_Supp", SqlDbType.Int);
            param[5].Value = id_Supp;
            param[6] = new SqlParameter("@id_Cust", SqlDbType.Int);
            param[6].Value = id_cust;

            da.excutequery("AddOpeningBalance", param);
            da.close();
        }

        internal void updateOpeningBalance( DateTime Date, decimal Moneydiscount, decimal Moneyadd, string Elbyan, int id_cust)
        {
            ...
            param[4] = new SqlParameter("@id_Cust", SqlDbType.Int);
            param[4].Value = id_cust;
           

            da.excutequery("updateOpeningBalance", param);
            da.close();
        }

        internal DataTable selectOpeniningBalance(string type)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[0].Value = type;
            dt = da.selected("selectOpeniningBalance", param);
            da.close();
            return dt;
        }


        internal void Update_CustomerStatmentAccount(int id_cust, Decimal Da2n, decimal Maden, string Elbyan, DateTime Date, decimal Balance, string SalesMan)
        {
            ...
            param[6] = new SqlParameter("@SalesMan", SqlDbType.NVarChar);
            param[6].Value = SalesMan;
            da.excutequery("Update_CustomerStatmentAccount", param);
            da.close();
        }

        internal void deleteOpeningBalance( decimal moneyadd,decimal moneydisco, string Elbyan, int id_cust)
        {
            ...
            param[3] = new SqlParameter("@idCast", SqlDbType.Int);
            param[3].Value = id_cust;
     



            da.excutequery("deleteOpeningBalance", param);
            da.close();
        }
