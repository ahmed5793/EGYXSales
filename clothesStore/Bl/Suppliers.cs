    ...
    class Suppliers
    {
        ...
        internal void addMoneySupplier(int id_inform, decimal rent, int id_supp)
        {
          ...
          internal void ADDSuppliersINFORMARION(int SupID,DateTime date,string note,string salesMan,
              decimal  total_invoic,decimal pay ,decimal rent, int Id_Stock ,decimal totalDiscount,decimal totalAfterDicscount)
        {
            ...
            param[8] = new SqlParameter("@totalDiscount", SqlDbType.Decimal);
            param[8].Value = totalDiscount;
            param[9] = new SqlParameter("@totalAfterDicscount", SqlDbType.Decimal);
            param[9].Value = totalAfterDicscount;
        ...
        internal DataTable SelectProductForUpdate(int id)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectProductForUpdate", param);
            da.close();
            return dt;
        }
        internal void UpdateSuppliersINformation(int id, string  note, decimal TotalInnvoice, decimal Pay, decimal Rent, 
            decimal Totaldiscount, decimal totalAfterDiscount,DateTime UpdateDate,string UserUpdate)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[0] = new SqlParameter("@id", SqlDbType.Int);
            param[0].Value = id;
            param[1] = new SqlParameter("@note", SqlDbType.NVarChar,350);
            param[1].Value = note;
            param[2] = new SqlParameter("@Total_Invoic", SqlDbType.Decimal);
            param[2].Value = TotalInnvoice;
            param[3] = new SqlParameter("@pay", SqlDbType.Decimal);
            param[3].Value = Pay;
            param[4] = new SqlParameter("@rent", SqlDbType.Decimal);
            param[4].Value = Rent;
            param[5] = new SqlParameter("@totalDiscount", SqlDbType.Decimal);
            param[5].Value = Totaldiscount;
            param[6] = new SqlParameter("@totalAfterDicscount", SqlDbType.Decimal);
            param[6].Value = totalAfterDiscount;
            param[7] = new SqlParameter("@UpdateDate", SqlDbType.DateTime);
            param[7].Value = UpdateDate; 
            param[8] = new SqlParameter("@UpdateUser", SqlDbType.NVarChar,50);
            param[8].Value = UserUpdate;
        ...
        internal DataTable DeleteSuppliersInformation (int id_Informa)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("[DeleteSuppliersInformation]", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable Deleted_Purshasing(DateTime DateFrom, DateTime DateTo)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[1] = new SqlParameter("@DateTo", SqlDbType.Date);
            param[1].Value = DateTo;
            dt = da.selected("Deleted_Purshasing", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable Select_ProductForButtonSuppliers(int ID_Prod)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[1];
            ...
            DataTable dt = new DataTable();
            dt = da.selected("Select_ProductForButtonSuppliers", param);
            da.close();
            return dt;
        }
        internal DataTable SelectQuantityOFProductFromSuppliersReturn(int id_Order, int ID_Product)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            dt = da.selected("SelectQuantityOFProductFromSuppliersReturn", param);
            da.close();
            return dt;
        }


        internal void Update_SupplierStatmentAccount(int ID_supp, decimal Da2n, decimal Maden, string Elbyan, DateTime Date, decimal Balance)
        {
            ...
            da.excutequery("Update_SupplierStatmentAccount", param);
            da.close();
        }

        internal void updateOpeningBalanceSupp(DateTime Date, decimal Moneydiscount, decimal Moneyadd, string Elbyan, int idsupp )
        {
            ...
            param[0].Value = Date;
            param[1] = new SqlParameter("@Moneydiscount", SqlDbType.Decimal);
            param[1].Value = Moneydiscount;
            param[2] = new SqlParameter("@Moneyadd", SqlDbType.Decimal);
            param[2].Value = Moneyadd;
            param[3] = new SqlParameter("@bayan", SqlDbType.NVarChar, 100);
            param[3].Value = Elbyan;

           
            param[4] = new SqlParameter("@idsupp", SqlDbType.Int);
            param[4].Value = idsupp;

            da.excutequery("updateOpeningBalanceSupp", param);
            da.close();
        }
        internal void deleteOpeningBalanceSupp(decimal moneyadd, decimal moneydisco, string Elbyan,int idsupp )
        {
            ...
            param[0] = new SqlParameter("@moneyadd", SqlDbType.Decimal);
            param[0].Value = moneyadd;
            param[1] = new SqlParameter("moneydisco", SqlDbType.Decimal);
            param[1].Value = moneydisco;
            param[2] = new SqlParameter("@elbayan", SqlDbType.NVarChar, 100);
            param[2].Value = Elbyan;
         
            param[3] = new SqlParameter("@idsupp", SqlDbType.Int);
            param[3].Value = idsupp;



            da.excutequery("deleteOpeningBalanceSupp", param);
            da.close();
        }
        internal void AddRemovePurshasesInProudect(int ID_Order, int ID_Prod, decimal @quantity, string Elbyan)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[4];
            ...
            param[2] = new SqlParameter("@quantity", SqlDbType.Decimal);
            param[2].Value = quantity;
            param[3] = new SqlParameter("@Bayan", SqlDbType.NVarChar, 50);
            param[3].Value = Elbyan;
            da.excutequery("AddRemovePurshasesInProudect", param);
            da.close();
        }
    }
