...
namespace clothesStore.Bl
{
    class Proudect
    {
                                  ...
                                  decimal Purshasing_Price, decimal minimun, string color, string Barcode, byte[] Image)
        {
            ...
            param[6].Value = color;
            param[7] = new SqlParameter("@Barcode", SqlDbType.NVarChar);
        ...
        public DataTable selectProudectByBarcode()
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            DataTable ds = new DataTable();
            ds = da.selected("selectProudectByBarcode", null);
            da.close();
            return ds;
        }
        ...
        internal DataTable SearchMovePorduct(DateTime Date_From, DateTime Date_To,int Id_Product)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[3];
            ...
            param[2] = new SqlParameter("@ID_Product", SqlDbType.Int);
        ...
        public DataTable Select_ProductForButton(int idCategory)
        {
            DataAccessLayer da = new DataAccessLayer();
            ...
            DataTable ds = new DataTable();
            ds = da.selected("Select_ProductForButton", param);
            da.close();
            return ds;
        }

        public DataTable Select_ProductForButtonSupplier(int idCategory)
        {
            DataAccessLayer da = new DataAccessLayer();
            ...
            DataTable ds = new DataTable();
            ds = da.selected("Select_ProductForButtonSupplier", param);
            da.close();
            return ds;
        }

        internal DataTable deleteProudectinUpdate(int Id_Category)
        {
            DataAccessLayer da = new DataAccessLayer();
            DataTable dt = new DataTable();
            da.open();
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@idProud", SqlDbType.Int);
            param[0].Value = Id_Category;

            dt = da.selected("deleteProudectinUpdate", param);
            da.close();
            return dt;
        }

        public DataTable TestProudect(DateTime Datefrom , DateTime dateTo)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[2];
            param[0] = new SqlParameter("@formdate", SqlDbType.Date);
            param[0].Value = Datefrom;
            param[1] = new SqlParameter("@todate", SqlDbType.Date);
            param[1].Value = dateTo;
            DataTable ds = new DataTable();
            da.open();
            ds = da.selected("TestProudect", param);
            da.close();
            return ds;
        }
        public DataTable SelectTotalDiscount(DateTime Datefrom, DateTime dateTo)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[2];
            param[0] = new SqlParameter("@formdate", SqlDbType.Date);
            ...
            DataTable ds = new DataTable();
            da.open();
            ds = da.selected("SelectTotalDiscount", param);
            da.close();
            return ds;
        }
                                  ...
                                  string Bayan, DateTime MoveDate, string SalesMan, string Type)
        {
            ...
            param[0] = new SqlParameter("@Id_Product", SqlDbType.Int);
            param[0].Value = Id_Product;
            param[1] = new SqlParameter("@InComeQty", SqlDbType.Int);
            param[1].Value = IncomeQty;
            param[2] = new SqlParameter("@InComePrice", SqlDbType.Decimal);
            param[2].Value = InComePrice;
            param[3] = new SqlParameter("@OutComeQty", SqlDbType.Int);
            param[3].Value = OutComeQty;
            param[4] = new SqlParameter("@OutComePrice", SqlDbType.Decimal);
            param[4].Value = OutComePrice;
            param[5] = new SqlParameter("@lastQty", SqlDbType.Decimal);
            param[5].Value = LastQty;
            param[6] = new SqlParameter("@LastIncomePrice", SqlDbType.Decimal);
            param[6].Value = LastInComePrice;
            param[7] = new SqlParameter("@LastOutComePrice", SqlDbType.Decimal);
            param[7].Value = LastOutComePrice;
            param[8] = new SqlParameter("@Bayan", SqlDbType.NVarChar, 500);
            param[8].Value = Bayan;
            param[9] = new SqlParameter("@MoveDate", SqlDbType.DateTime);
            param[9].Value = MoveDate;
            param[10] = new SqlParameter("@SalesMan", SqlDbType.NVarChar, 50);
            param[10].Value = SalesMan;
            param[11] = new SqlParameter("@Type", SqlDbType.NVarChar, 50);
            param[11].Value = Type;
            da.excutequery("Add_MoveProduct", param);
            da.close();

        }

        public DataTable SelectListSuppliersForPursh(int idProud)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[1];
            param[0] = new SqlParameter("@idProud", SqlDbType.Int);
            param[0].Value = idProud;
            DataTable ds = new DataTable();
            ds = da.selected("SelectListSuppliersForPursh", param);
            da.close();
            return ds;


        }
        public DataTable Select_ProductFormCategory(int idcategory)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[1];
            ...
            param[0].Value = idcategory;
            DataTable ds = new DataTable();
            ds = da.selected("Select_ProductFormCategory", param);
            da.close();
            return ds;

        }
        public DataTable SelectAverageBuyPrice(DateTime DateFrom, DateTime DateTo)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[2];
            ...
            param[1].Value = DateTo;
            DataTable ds = new DataTable();
            ds = da.selected("SelectAverageBuyPrice", param);
            da.close();
            return ds;

        }

        internal void AddItemsFirstTerm(int ID_Prod, string name, int ID_Category, decimal Quantity, decimal Sales_Price,decimal Purshasing_Price)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[6];
            ...
            param[3] = new SqlParameter("@Quantity", SqlDbType.Decimal);
            param[3].Value = Quantity;
            param[4] = new SqlParameter("@Sales_price", SqlDbType.Decimal);
            param[4].Value = Sales_Price;
            param[5] = new SqlParameter("@Buy_Price", SqlDbType.Decimal);
            param[5].Value = Purshasing_Price;
         
            da.excutequery("AddItemsFirstTerm", param);
            da.close();

        }

        public DataTable selectItemsFirstTerm()
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            DataTable ds = new DataTable();
            ds = da.selected("selectItemsFirstTerm", null);
            da.close();
            return ds;
        }
        public DataTable ReportStoreValueLast()
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            DataTable ds = new DataTable();
            ds = da.selected("ReportStoreValueLast", null);
            da.close();
            return ds;
        }
