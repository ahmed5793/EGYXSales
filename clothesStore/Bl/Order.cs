...
namespace clothesStore.Bl
{
    class Order
    {
        ...
        internal void AddOrder(DateTime date_order,int idCust, string discraption,string salesMan, decimal totalinvo, decimal pay, 
                                decimal rent,int id_Stock,decimal AddService, decimal AddNa2l,decimal total_AfterDisc ,decimal total_Discount)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[8] = new SqlParameter("@AddService", SqlDbType.Decimal);
            param[8].Value = AddService;
            param[9] = new SqlParameter("@AddNa2l", SqlDbType.Decimal);
            param[9].Value = AddNa2l;
            param[10] = new SqlParameter("@total_AfterDisc", SqlDbType.Decimal);
            param[10].Value = total_AfterDisc;
            param[11] = new SqlParameter("@total_Discount", SqlDbType.Decimal);
            param[11].Value = total_Discount;
        ...
        internal void UpateOrderShow(int id_Order, string  show)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[1] = new SqlParameter("@show", SqlDbType.NVarChar,50);
            param[1].Value = show;
         
            da.excutequery("UpateOrderShow", param);
            da.close();
        }
        ...
        internal DataTable Select_Deleted_Orders(DateTime DateFrom, DateTime DateTo)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("Select_Deleted_Orders", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable SelectProdUpdateOrder(int id)
        {
            DataTable dt = new DataTable();
            ...
            dt = da.selected("SelectProdUpdateOrder", param);
            da.close();
            return dt;
        }
        ...
        internal DataTable SelectSalesReb7( DateTime formdate,DateTime todate)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
        ...
        internal DataTable SelectOrderData (int id_Order)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[0] = new SqlParameter("@Id_Order", SqlDbType.Int);
            param[0].Value = id_Order;
            dt = da.selected("SelectOrderData", param);
            da.close();
            return dt;
        }
        internal void Update_OrderNa2lAndTrkeb(int ID_Order, decimal Na2l,decimal Trkeb)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@ID_Order", SqlDbType.Int);
            param[0].Value = ID_Order;
            param[1] = new SqlParameter("@N2al", SqlDbType.Decimal);
            param[1].Value = Na2l;
            param[2] = new SqlParameter("@trkeb", SqlDbType.Decimal);
            param[2].Value = Trkeb;
            da.excutequery("Update_OrderNa2lAndTrkeb", param);
            da.close();
        }

        internal void AddRemoveInProudect(int ID_Order, int ID_Prod, decimal @quantity , string Elbyan)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[4];
            ...
            da.excutequery("AddRemoveInProudect", param);
            da.close();
        }
        internal void Delete_OrderDetails(int ID_Order)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[1];
            ...
            da.excutequery("Delete_OrderDetails", param);
            da.close();
        }


        internal void updateOrder( decimal totalinvo, decimal pay,decimal rent, decimal AddService, decimal AddNa2l,
            decimal total_AfterDisc, decimal total_Discount,int idOrder,string Description,string Update_User , DateTime Update_Date)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[11];      
            param[0] = new SqlParameter("@Total_Invoic", SqlDbType.Decimal);
            param[0].Value = totalinvo;
            param[1] = new SqlParameter("@pay", SqlDbType.Decimal);
            param[1].Value = pay;
            param[2] = new SqlParameter("@rent", SqlDbType.Decimal);
            param[2].Value = rent;
            param[3] = new SqlParameter("@AddService", SqlDbType.Decimal);
            param[3].Value = AddService;
            param[4] = new SqlParameter("@AddNa2l", SqlDbType.Decimal);
            param[4].Value = AddNa2l;
            param[5] = new SqlParameter("@total_AfterDisc", SqlDbType.Decimal);
            param[5].Value = total_AfterDisc;
            param[6] = new SqlParameter("@total_Discount", SqlDbType.Decimal);
            param[6].Value = total_Discount;
            param[7] = new SqlParameter("@idOrder", SqlDbType.Int);
            param[7].Value = idOrder;
            param[8] = new SqlParameter("@Discraption", SqlDbType.NVarChar,250);
            param[8].Value = Description;
            param[9] = new SqlParameter("@Update_User", SqlDbType.NVarChar,50);
            param[9].Value = Update_User;
            param[10] = new SqlParameter("@Update_Date", SqlDbType.DateTime);
            param[10].Value = Update_Date;
            da.excutequery("updateOrder", param);
            da.close();
        }


        internal DataTable ReportAboutOrderReturn(DateTime  formdate, DateTime todate)
        {
            DataTable dt = new DataTable();
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            dt = da.selected("ReportAboutOrderReturn", param);
            da.close();
            return dt;
        }
