...
namespace clothesStore.Bl
{
   ...
   int Pay_Suppliers, int Account_Suppliers, int Depit_Suppliers)
        ...
        internal void AddUserOrder(string User_Name, int Add_Order, int ReturnOrder, int ManagmentOrder,
                                   int ReportReturnOrder, int Report_Reb7Order,int updateOrder,int Return_AllProduct)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[8];
            ...
            param[6] = new SqlParameter("@updateOrder", SqlDbType.Int);
            param[6].Value = updateOrder;
            param[7] = new SqlParameter("@Return_AllProduct", SqlDbType.Int);
            param[7].Value = Return_AllProduct;
        ...
        internal void AddUserPurshise(string User_Name, int Add_OrderSuppliers, int ReturnSuppliers, int ManagmentSuppliers,
                           int Report_ReturnSuppliers,int Report_ReturnAllProduct)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[5] = new SqlParameter("@Report_ReturnAllProduct", SqlDbType.Int);
            param[5].Value = Report_ReturnAllProduct;
        ...
        internal void AddUserStock(string User_Name, int Add_Stock, int Add_Masrof, int Transfer_Stock,
              int Ms7obat_Sh5sya, int Eradat, int Elasol, int EhlaktElasol, int Report_Money)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            ...
            param[2] = new SqlParameter("@Add_Stock", SqlDbType.Int);
            param[2].Value = Add_Stock;
            param[3] = new SqlParameter("@Transfer_Stock", SqlDbType.Int);
            param[3].Value = Transfer_Stock;

            param[4] = new SqlParameter("@Ms7obatSh5sya", SqlDbType.Int);
            param[4].Value = Ms7obat_Sh5sya;
            param[5] = new SqlParameter("@eradat", SqlDbType.Int);
            param[5].Value = Eradat;

            param[6] = new SqlParameter("@elsol", SqlDbType.Int);
            param[6].Value = Elasol;
            param[7] = new SqlParameter("@EhlakatElasol", SqlDbType.Int);
            param[7].Value = EhlaktElasol;
            param[8] = new SqlParameter("@Report_Money", SqlDbType.Int);
            param[8].Value = Report_Money;

            da.excutequery("AddUserStock", param);
            da.close();
        }
        internal void UpdateUserStock(string User_Name, int Add_Stock ,int Add_Masrof, int Transfer_Stock,
            int Ms7obat_Sh5sya, int Eradat,int Elasol, int EhlaktElasol, int Report_Money)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
        ...
        int Managment_User, int Managment_Employee,int DeleteAllData, int MoveUser, int USerSales)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[9];
            ...
            param[6] = new SqlParameter("@DeleteAllData", SqlDbType.Int);
            param[6].Value = DeleteAllData;
            param[7] = new SqlParameter("@MoveUsers", SqlDbType.Int);
            param[7].Value = MoveUser;
            param[8] = new SqlParameter("@UserSales", SqlDbType.Int);
            param[8].Value = USerSales;
