...
namespace clothesStore.Bl
{
    class Store
    {
        ...
        internal void Updatestorevalue(decimal StoreValue, DateTime Date, int ID)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[3];
            param[0] = new SqlParameter("@StoreValue", SqlDbType.Decimal);
            param[0].Value = StoreValue;
            param[1] = new SqlParameter("@Date", SqlDbType.DateTime);
            param[1].Value = Date;
            param[2] = new SqlParameter("@ID", SqlDbType.Int);
            param[2].Value = ID;
            da.excutequery("Updatestorevalue", param);
            da.close();
        }

        internal void AddStoreValue(decimal StoreValue, DateTime Date)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[2];
            ...
            da.excutequery("AddStoreValue", param);
            da.close();
        }

        internal DataTable selectStoreValue()
        {
            DataAccessLayer da = new DataAccessLayer();

            da.open();
            DataTable dt = new DataTable();
            dt = da.selected("selectStoreValue", null);
            return dt;
        }
    }
}
