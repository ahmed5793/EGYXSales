...
namespace clothesStore.Bl
{
    class Login
    {
        ...
        internal void addMoveUser(string UserName, string ScreenName,string TypeMove)
        {
            DataAccessLayer da = new DataAccessLayer();
            da.open();
            SqlParameter[] param = new SqlParameter[3];
            ...
            param[1] = new SqlParameter("@ScreenName", SqlDbType.NVarChar, 50);
            param[1].Value = ScreenName;
            param[2] = new SqlParameter("@TypeMove", SqlDbType.NVarChar, 500);
            param[2].Value = TypeMove;
            da.excutequery("addMoveUser", param);
            da.close();
        }


        internal DataTable selectRptUserMove(DateTime @fromDate,DateTime @ToDate)
        {
            DataAccessLayer da = new DataAccessLayer();
            SqlParameter[] param = new SqlParameter[2];
            ...
            da.open();
            DataTable dt = new DataTable();
            dt = da.selected("selectRptUserMove", param);
